...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let typhOHSymbol = DeveloperToolsSupport.ImageResource(name: "TyphOH.symbol", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "Claude" asset catalog image.
    static var claude: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
    ...
    /// The "Gemini" asset catalog image.
    static var gemini: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .gemini)
#else
        .init()
#endif
    }

    /// The "TyphOH.symbol" asset catalog image.
    static var typhOHSymbol: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .typhOHSymbol)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "Claude" asset catalog image.
    static var claude: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .claude)
#else
        .init()
    ...
    /// The "Gemini" asset catalog image.
    static var gemini: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .gemini)
#else
        .init()
    ...
    /// The "TyphOH.symbol" asset catalog image.
    static var typhOHSymbol: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .typhOHSymbol)
#else
        .init()
